...
def _add_hf_args(parser):
    group = parser.add_argument_group(title="hf")
    group.add_argument('--return-logits', action='store_true', help='return logits', default=False)
    return parser
